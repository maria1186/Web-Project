...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // Works only add css for .is-active

jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('ul li a').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('li a').removeClass("is-active");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("is-active");
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() >= 120) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.top-bar').addClass('fixed-header');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('top-bar').removeClass('fixed-header');
  }
});
...
module.exports = __webpack_require__(/*! C:\Users\Lubo\ClaritinBayer\src\assets\js\app.js */"./src/assets/js/app.js");
